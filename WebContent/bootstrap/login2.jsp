            ...
            <td>
              ...
              <!-- Student Login -->
                ...
                <form action="../Student_Login_Servlet" method="post">
                        ...
                        <table>
                            <tr><div class="form-group col-lg-4">
                            ...
                            <div class="form-group col-lg-12">                                
                                <input type="submit" name="submit1" class="btn btn-default" value="Login">
                            </div>
                            </tr>
                            </table>
                        </div>
              ...
              <!-- Faculty Login Starts --> 
                ...
                <form role="form" action="Faculty_Login_Servlet" method="post">
                        ...
                        <table>
                            ...
                            <div class="form-group col-lg-12">                                
                                <input type="submit" name="submit2" class="btn btn-default" value="Login" >
                            </div>
                            </tr>
                            </table>
                        </div>
