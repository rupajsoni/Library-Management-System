...
public class login_dao {
	...
	try
	{
		System.out.println("Hello I am in TRY");
		Class.forName("oracle.jdbc.driver.OracleDriver");
		System.out.println("Hello I am in TRY after class.for name");
		//connect=DriverManager.getConnection("jdbc:oracle:thin:@ora.csc.ncsu.edu:1521:orcl","kpharas","200109081");
		connect=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:orcl","sys","adi");
